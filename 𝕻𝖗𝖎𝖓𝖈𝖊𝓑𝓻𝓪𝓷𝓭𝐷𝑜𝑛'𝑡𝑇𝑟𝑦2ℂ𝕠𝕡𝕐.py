...
def approval():
  ...
  print ("""\033[1;37m----------------------------------------------""")
  try:
    httpCaht = requests.get("https://raw.githubusercontent.com/Prince162/Approval-/main/approval.txt").text
    if id in httpCaht:
...
def passu():
	...
	linex()
	prog = Progress(TextColumn(' [𝕻𝖗𝖎𝖓𝖈𝖊-𝕭𝖗𝖆𝖓𝕯]{task.description}'))
